...
public class HospitalTest {
    ...
    public void shouldAdmitTwoPatients(){
        Patient sickPatient = new Patient(); //default sickPatient
        Patient sickerPatient = new Patient(5,10);
        underTest.admit(sickPatient);
        underTest.admit(sickerPatient);
        Collection<Patient> admittedPatient = underTest.getAllPatients();
        assertThat(admittedPatient, containsInAnyOrder(sickPatient, sickerPatient));
    }
}
